...
<p class="summary">Find answers to recurring questions and myths about ocpforum.</p>
...
<h3><a name="what-is-ocpforum">What is ocpforum?</a></h3>
...
<h3><a name="who-created-ocpforum">Who created ocpforum?</a></h3>
...
<h3><a name="who-controls-the-ocpforum-network">Who controls the ocpforum network?</a></h3>
<p>Nobody owns the ocpforum network much like no one owns the technology behind email. ocpforum is controlled by all ocpforum users around the world. While developers are improving the software, they can't force a change in the ocpforum protocol because all users are free to choose what software and version they use. In order to stay compatible with each other, all users need to use software complying with the same rules. ocpforum can only work correctly with a complete consensus among all users. Therefore, all users and developers have a strong incentive to protect this consensus.</p>

<h3><a name="how-does-ocpforum-work">How does ocpforum work?</a></h3>
...
<h3><a name="is-ocpforum-really-used-by-people">Is ocpforum really used by people?</a></h3>
...
<p>
<img src="http://ocpforum.org/img/faq/merchants_map.png" alt="Screenshot">
</p>

<h3><a name="how-does-one-acquire-ocpforums">How does one acquire ocpforums?</a></h3>
<ul>
...
<h3><a name="how-difficult-is-it-to-make-a-ocpforum-payment">How difficult is it to make a ocpforum payment?</a></h3>
...
<p>
<img src="http://ocpforum.org/img/faq/mobile_send.png" alt="Screenshot">
<img src="http://ocpforum.org/img/faq/mobile_receive.png" alt="Screenshot">
</p>

<h3><a name="what-are-the-advantages-of-ocpforum">What are the advantages of ocpforum?</a></h3>
<ul>
...
<h3><a name="what-are-the-disadvantages-of-ocpforum">What are the disadvantages of ocpforum?</a></h3>
<ul>
...
<h3><a name="why-do-people-trust-ocpforum">Why do people trust ocpforum?</a></h3>
...
<h3><a name="can-i-make-money-with-ocpforum">Can I make money with ocpforum?</a></h3>
<p>You should never expect to get rich with ocpforum or any emerging technology. It is always important to be wary of anything that sounds too good to be true or disobeys basic economic rules.</p>
<p>ocpforum is a growing space of innovation and there are business opportunities that also include risks. There is no guarantee that ocpforum will continue to grow even though it has developed at a very fast rate so far. Investing time and resources on anything related to ocpforum requires entrepreneurship. There are various ways to make money with ocpforum such as mining, speculation or running new businesses. All of these methods are competitive and there is no guarantee of profit. It is up to each individual to make a proper evaluation of the costs and the risks involved in any such project.</p>

<h3><a name="is-ocpforum-fully-virtual-and-immaterial">Is ocpforum fully virtual and immaterial?</a></h3>
...
<h3><a name="is-ocpforum-anonymous">Is ocpforum anonymous?</a></h3>
...
<h3><a name="what-happens-when-ocpforums-are-lost">What happens when ocpforums are lost?</a></h3>
<p>When a user loses his wallet, it has the effect of removing money out of circulation. Lost ocpforums still remain in the block chain just like any other ocpforums. However, lost ocpforums remain dormant forever because there is no way for anybody to find the private key(s) that would allow them to be spent again. Because of the law of supply and demand, when fewer ocpforums are available, the ones that are left will be in higher demand and increase in value to compensate.</p>

<h3><a name="can-ocpforum-scale-to-become-a-major-payment-network">Can ocpforum scale to become a major payment network?</a></h3>
<p>The ocpforum network can already process a much higher number of transactions per second than it does today. It is, however, not entirely ready to scale to the level of major credit card networks. Work is underway to lift current limitations, and future requirements are well known. Since inception, every aspect of the ocpforum network has been in a continuous process of maturation, optimization, and specialization, and it should be expected to remain that way for some years to come. As traffic grows, more ocpforum users may use lightweight clients, and full network nodes may become a more specialized service. For more details, see the <a href="https://en.ocpforum.it/wiki/Scalability">Scalability</a> page on the Wiki.</p>

<h2><a name="legal">Legal</a></h2>

<h3><a name="is-ocpforum-legal">Is ocpforum legal?</a></h3>
...
<h3><a name="is-ocpforum-useful-for-illegal-activities">Is ocpforum useful for illegal activities?</a></h3>
...
<h3><a name="can-ocpforum-be-regulated">Can ocpforum be regulated?</a></h3>
<p>The ocpforum protocol itself cannot be modified without the cooperation of nearly all its users, who choose what software they use. Attempting to assign special rights to a local authority in the rules of the global ocpforum network is not a practical possibility. Any rich organization could choose to invest in mining hardware to control half of the computing power of the network and become able to block or reverse recent transactions. However, there is no guarantee that they could retain this power since this requires to invest as much than all other miners in the world.</p>
<p>It is however possible to regulate the use of ocpforum in a similar way to any other instrument. Just like the dollar, ocpforum can be used for a wide variety of purposes, some of which can be considered legitimate or not as per each jurisdiction's laws. In this regard, ocpforum is no different than any other tool or resource and can be subjected to different regulations in each country. ocpforum use could also be made difficult by restrictive regulations, in which case it is hard to determine what percentage of users would keep using the technology. A government that chooses to ban ocpforum would prevent domestic businesses and markets from developing, shifting innovation to other countries. The challenge for regulators, as always, is to develop efficient solutions while not impairing the growth of new emerging markets and businesses.</p>

<h3><a name="what-about-ocpforum-and-taxes">What about ocpforum and taxes?</a></h3>
...
<h3><a name="what-about-ocpforum-and-consumer-protection">What about ocpforum and consumer protection?</a></h3>
<p>ocpforum is freeing people to transact on their own terms. Each user can send and receive payments in a similar way to cash but they can also take part in more complex contracts. Multiple signatures allow a transaction to be accepted by the network only if a certain number of a defined group of persons agree to sign the transaction. This allows innovative dispute mediation services to be developed in the future. Such services could allow a third party to approve or reject a transaction in case of disagreement between the other parties without having control on their money. As opposed to cash and other payment methods, ocpforum always leave a public proof that a transaction did take place, which can potentially be used in a recourse against businesses with fraudulent practices.</p>
<p>It is also worth noting that while merchants usually depend on their public reputation to remain in business and pay their employees, they don't have access to the same level of information when dealing with new consumers. The way ocpforum works allows both individuals and businesses to be protected against fraudulent chargebacks while giving the choice to the consumer to ask for more protection when they are not willing to trust a particular merchant.</p>

<h2><a name="economy">Economy</a></h2>

<h3><a name="how-are-ocpforums-created">How are ocpforums created?</a></h3>
<p>New ocpforums are generated by a competitive and decentralized process called "mining". This process involves that individuals are rewarded by the network for their services. ocpforum miners are processing transactions and securing the network using specialized hardware and are collecting new ocpforums in exchange.</p>
<p>The ocpforum protocol is designed in such a way that new ocpforums are created at a fixed rate. This makes ocpforum mining a very competitive business. When more miners join the network, it becomes increasingly difficult to make a profit and miners must seek efficiency to cut their operating costs. No central authority or developer has any power to control or manipulate the system to increase their profits. Every ocpforum node in the world will reject anything that does not comply with the rules it expects the system to follow.</p>
<p>ocpforums are created at a decreasing and predictable rate. The number of new ocpforums created each year is automatically halved over time until ocpforum issuance halts completely with a total of 21 million ocpforums in existence. At this point, ocpforum miners will probably be supported exclusively by numerous small transaction fees.</p>

<h3><a name="why-do-ocpforums-have-value">Why do ocpforums have value?</a></h3>
...
<h3><a name="what-determines-ocpforums-price">What determines ocpforum’s price?</a></h3>
<p>The price of a ocpforum is determined by supply and demand. When demand for ocpforums increases, the price increases, and when demand falls, the price falls. There is only a limited number of ocpforums in circulation and new ocpforums are created at a predictable and decreasing rate, which means that demand must follow this level of inflation to keep the price stable. Because ocpforum is still a relatively small market compared to what it could be, it doesn't take significant amounts of money to move the market price up or down, and thus the price of a ocpforum is still very volatile.</p>
<p>ocpforum price, 2011 to 2013:<br><img src="http://ocpforum.org/img/faq/price_chart.png" alt="chart"></p>

<h3><a name="can-ocpforums-become-worthless">Can ocpforums become worthless?</a></h3>
...
<h3><a name="is-ocpforum-a-bubble">Is ocpforum a bubble?</a></h3>
...
<h3><a name="is-ocpforum-a-ponzi-scheme">Is ocpforum a Ponzi scheme?</a></h3>
...
<h3><a name="doesnt-ocpforum-unfairly-benefit-early-adopters">Doesn't ocpforum unfairly benefit early adopters?</a></h3>
<p>Some early adopters have large numbers of ocpforums because they took risks and invested time and resources in an unproven technology that was hardly used by anyone and that was much harder to secure properly. Many early adopters spent large numbers of ocpforums quite a few times before they became valuable or bought only small amounts and didn't make huge gains. There is no guarantee that the price of a ocpforum will increase or drop. This is very similar to investing in an early startup that can either gain value through its usefulness and popularity, or just never break through. ocpforum is still in its infancy, and it has been designed with a very long-term view; it is hard to imagine how it could be less biased towards early adopters, and today's users may or may not be the early adopters of tomorrow.</p>

<h3><a name="wont-the-finite-amount-of-ocpforums-be-a-limitation">Won't the finite amount of ocpforums be a limitation?</a></h3>
<p>ocpforum is unique in that only 21 million ocpforums will ever be created. However, this will never be a limitation because ocpforums can be divided up to 8 decimal places ( 0.000 000 01 BTC ) and potentially even smaller units if that is ever required in the future. As the average transaction size decreases, transactions can be denominated in sub-units of a ocpforum, such as milliocpforums ( 1 mBTC or 0.001 BTC ).</p>

<h3><a name="wont-ocpforum-fall-in-a-deflationary-spiral">Won't ocpforum fall in a deflationary spiral?</a></h3>
...
<p>Although this theory is a popular way to justify inflation amongst central bankers, it does not appear to always hold true and is considered controversial amongst economists. Consumer electronics is one example of a market where prices constantly fall but which is not in depression. Similarly, the value of ocpforums has risen over time and yet the size of the ocpforum economy has also grown dramatically along with it. Because both the value of the currency and the size of its economy started at zero in 2009, ocpforum is a counterexample to the theory showing that it must sometimes be wrong.</p>
<p>Notwithstanding this, ocpforum is not designed to be a deflationary currency. It is more accurate to say ocpforum is intended to inflate in its early years, and become stable in its later years. The only time the quantity of ocpforums in circulation will drop is if people carelessly lose their wallets by failing to make backups. With a stable monetary base and a stable economy, the value of the currency should remain the same.</p>

<h3><a name="isnt-speculation-and-volatility-a-problem-for-ocpforum">Isn't speculation and volatility a problem for ocpforum?</a></h3>
<p>This is a chicken and egg situation. For ocpforum's price to stabilize, a large scale economy needs to develop with more businesses and users. For a large scale economy to develop, businesses and users will seek for price stability.</p>
<p>Fortunately, volatility does not affect the main benefits of ocpforum as a payment system to transfer money from point A to point B. It is possible for businesses to convert ocpforum payments to their local currency instantly, allowing them to profit from the advantages of ocpforum without being subjected to price fluctuations. Since ocpforum offers many useful and unique features and properties, many users choose to use ocpforum. With such solutions and incentives, it is possible that ocpforum will mature and develop to a degree where price volatility will become limited.</p>

<h3><a name="what-if-someone-bought-up-all-the-existing-ocpforums">What if someone bought up all the existing ocpforums?</a></h3>
<p>Only a fraction of ocpforums issued to date are found on the exchange markets for sale. ocpforum markets are competitive, meaning the price of a ocpforum will rise or fall depending on supply and demand. Additionally, new ocpforums will continue to be issued for decades to come. Therefore even the most determined buyer could not buy all the ocpforums in existence. This situation isn't to suggest, however, that the markets aren't vulnerable to price manipulation; it still doesn't take significant amounts of money to move the market price up or down, and thus ocpforum remains a volatile asset thus far.</p>

<h3><a name="what-if-someone-creates-a-better-digital-currency">What if someone creates a better digital currency?</a></h3>
<p>That can happen. For now, ocpforum remains by far the most popular decentralized virtual currency, but there can be no guarantee that it will retain that position. There is already a set of alternative currencies inspired by ocpforum. It is however probably correct to assume that significant improvements would be required for a new currency to overtake ocpforum in terms of established market, even though this remains unpredictable. ocpforum could also conceivably adopt improvements of a competing currency so long as it doesn't change fundamental parts of the protocol.</p>

<h2><a name="transactions">Transactions</a></h2>

<h3><a name="why-do-i-have-to-wait-10-minutes">Why do I have to wait 10 minutes?</a></h3>
<p>Receiving a payment is almost instant with ocpforum. However, there is a 10 minutes delay on average before the network begins to confirm your transaction by including it in a block and before you can spend the ocpforums you receive. A confirmation means that there is a consensus on the network that the ocpforums you received haven't been sent to anyone else and are considered your property. Once your transaction has been included in one block, it will continue to be buried under every block after it, which will exponentially consolidate this consensus and decrease the risk of a reversed transaction. Every user is free to determine at what point they consider a transaction confirmed, but 6 confirmations is often considered to be as safe as waiting 6 months on a credit card transaction.</p>

<h3><a name="how-much-will-the-transaction-fee-be">How much will the transaction fee be?</a></h3>
<p>Most transactions can be processed without fees, but users are encouraged to pay a small voluntary fee for faster confirmation of their transactions and to remunerate miners. When fees are required, they generally don't exceed a few pennies in value. Your ocpforum client will usually try to estimate an appropriate fee when required.</p>
<p>Transaction fees are used as a protection against users sending transactions to overload the network. The precise manner in which fees work is still being developed and will change over time. Because the fee is not related to the amount of ocpforums being sent, it may seem extremely low (0.0005 BTC for a 1,000 BTC transfer) or unfairly high (0.004 BTC for a 0.02 BTC payment). The fee is defined by attributes such as data in transaction and transaction recurrence. For example, if you are receiving a large number of tiny amounts, then fees for sending will be higher. Such payments are comparable to paying a restaurant bill using only pennies. Spending small fractions of your ocpforums rapidly may also require a fee. If your activity follows the pattern of conventional transactions, the fees should remain very low.</p>

<h3><a name="what-if-i-receive-a-ocpforum-when-my-computer-is-powered-off">What if I receive a ocpforum when my computer is powered off?</a></h3>
<p>This works fine. The ocpforums will appear next time you start your wallet application. ocpforums are not actually received by the software on your computer, they are appended to a public ledger that is shared between all the devices on the network. If you are sent ocpforums when your wallet client program is not running and you later launch it, it will download blocks and catch up with any transactions it did not already know about, and the ocpforums will eventually appear as if they were just received in real time. Your wallet is only needed when you wish to spend ocpforums.</p>
...
<p>Long synchronization time is only required with full node clients like ocpforum-Qt. Technically speaking, synchronizing is the process of downloading and verifying all previous ocpforum transactions on the network. For some ocpforum clients to calculate the spendable balance of your ocpforum wallet and make new transactions, it needs to be aware of all previous transactions. This step can be resource intensive and requires sufficient bandwidth and storage to accommodate the <a href="http://blockchain.info/charts/blocks-size">full size of the block chain</a>. For ocpforum to remain secure, enough people should keep using full node clients because they perform the task of validating and relaying transactions.</p>

<h2><a name="mining">Mining</a></h2>

<h3><a name="what-is-ocpforum-mining">What is ocpforum mining?</a></h3>
...
<h3><a name="how-does-ocpforum-mining-work">How does ocpforum mining work?</a></h3>
<p>Anybody can become a ocpforum miner by running software with specialized hardware. Mining software listens for transactions broadcast through the peer-to-peer network and performs appropriate tasks to process and confirm these transactions. ocpforum miners perform this work because they can earn transaction fees paid by users for faster transaction processing, and newly created ocpforums issued into existence according to a fixed formula.</p>
...
<p>ocpforum miners are neither able to cheat by increasing their own reward nor process fraudulent transactions that could corrupt the ocpforum network because all ocpforum nodes would reject any block that contains invalid data as per the rules of the ocpforum protocol. Consequently, the network remains secure even if not all ocpforum miners can be trusted.</p>

<h3><a name="isnt-ocpforum-mining-a-waste-of-energy">Isn't ocpforum mining a waste of energy?</a></h3>
<p>Spending energy to secure and operate a payment system is hardly a waste. Like any other payment service, the use of ocpforum entails processing costs. Services necessary for the operation of currently widespread monetary systems, such as banks, credit cards, and armored vehicles, also use a lot of energy. Although unlike ocpforum, their total energy consumption is not transparent and cannot be as easily measured.</p>
<p>ocpforum mining has been designed to become more optimized over time with specialized hardware consuming less energy, and the operating costs of mining should continue to be proportional to demand. When ocpforum mining becomes too competitive and less profitable, some miners choose to stop their activities. Furthermore, all energy expended mining is eventually transformed into heat, and the most profitable miners will be those who have put this heat to good use. An optimally efficient mining network is one that isn't actually consuming any extra energy. While this is an ideal, the economics of mining are such that miners individually strive toward it.</p>

<h3><a name="how-does-mining-help-secure-ocpforum">How does mining help secure ocpforum?</a></h3>
...
<p>In the early days of ocpforum, anyone could find a new block using their computer's CPU. As more and more people started mining, the difficulty of finding new blocks increased greatly to the point where the only cost-effective method of mining today is using specialized hardware. You can visit <a href="http://www.ocpforummining.com/">ocpforumMining.com</a> for more information.</p>

<h2><a name="security">Security</a></h2>

<h3><a name="is-ocpforum-secure">Is ocpforum secure?</a></h3>
...
<h3><a name="hasnt-ocpforum-been-hacked-in-the-past">Hasn't ocpforum been hacked in the past?</a></h3>
<p>The rules of the protocol and the cryptography used for ocpforum are still working years after its inception, which is a good indication that the concept is well designed. However, <a href="http://ocpforum.org/en/alerts">security flaws</a> have been found and fixed over time in various software implementations. Like any other form of software, the security of ocpforum software depends on the speed with which problems are found and fixed. The more such issues are discovered, the more ocpforum is gaining maturity.</p>
<p>There are often misconceptions about thefts and security breaches that happened on diverse exchanges and businesses. Although these events are unfortunate, none of them involve ocpforum itself being hacked, nor imply inherent flaws in ocpforum; just like a bank robbery doesn't mean that the dollar is compromised. However, it is accurate to say that a complete set of good practices and intuitive security solutions is needed to give users better protection of their money, and to reduce the general risk of theft and loss. Over the course of the last few years, such security features have quickly developed, such as wallet encryption, offline wallets, hardware wallets, and multi-signature transactions.</p>

<h3><a name="could-users-collude-against-ocpforum">Could users collude against ocpforum?</a></h3>
<p>It is not possible to change the ocpforum protocol that easily. Any ocpforum client that doesn't comply with the same rules cannot enforce their own rules on other users. As per the current specification, double spending is not possible on the same block chain, and neither is spending ocpforums without a valid signature. Therefore, It is not possible to generate uncontrolled amounts of ocpforums out of thin air, spend other users' funds, corrupt the network, or anything similar.</p>
<p>However, a majority of miners could arbitrarily choose to block or reverse recent transactions. A majority of users can also put pressure for some changes to be adopted. Because ocpforum only works correctly with a complete consensus between all users, changing the protocol can be very difficult and requires an overwhelming majority of users to adopt the changes in such a way that remaining users have nearly no choice but to follow. As a general rule, it is hard to imagine why any ocpforum user would choose to adopt any change that could compromise their own money.</p>

<h3><a name="is-ocpforum-vulnerable-to-quantum-computing">Is ocpforum vulnerable to quantum computing?</a></h3>
<p>Yes, most systems relying on cryptography in general are, including traditional banking systems. However, quantum computers don't yet exist and probably won't for a while. In the event that quantum computing could be an imminent threat to ocpforum, the protocol could be upgraded to use post-quantum algorithms. Given the importance that this update would have, it can be safely expected that it would be highly reviewed by developers and adopted by all ocpforum users.</p>

<h2><a name="help">Help</a></h2>

<h3><a name="more-help">I'd like to learn more. Where can I get help?</a></h3>
<p>You can find more information and help on the <a href="/en/resources">resources</a> and <a href="/en/community">community</a> pages or on the <a href="https://en.ocpforum.it/wiki/FAQ">Wiki FAQ</a>.</p>
