...
<div>
	<p>
		Bitcoin has no official organization, individuals with authority, nor spokespeople.
		<a href="javaScript:" onclick="$('#disclaimer').toggle()">Read more</a>
	</p>
	<p id="disclaimer">
		The Bitcoin project is open-source and, likewise, no one can speak with authority for Bitcoin.
		The Bitcoin community contains individuals who hold a wide spectrum of business experience or involvement,
		political ideas, personal opinions, technical competency, and style.
		This list of potential interviewees has been curated by Bitcoin community members
		with the intent to include individuals possessing a wide spectrum of experience, ideas, and geography.
		The individuals listed have been involved in the Bitcoin community for a significant period making tangible contributions,
		have demonstrated competence and professionalism when discussing Bitcoin,
		are flexible and willing to assist members of the press in both objective and persuasive ways,
		and are generally respected by other members of the Bitcoin community.
		However, an individual's appearance here should not be misconstrued as a general endorsement,
		either by the Bitcoin community or any particular individuals with, regards to potential interviewees
		and any businesses they may operate, nor any political or personal ideas they may expound,
		including prognostications about Bitcoin or the price or any other topic.
	</p>
</div>
...
<div class="of_tablehalf">
	...
	<div class="subnail_txt">
		<img src="http://bitcoin.org/img/press/volunteer/vitalik_buterin.jpg" alt="Vitalik Buterin">
		<p>Vitalik Buterin</p>
		<p>Bitcoin Magazine Head Writer</p>
		<p class="details">
			<a href="http://www.bbc.co.uk/news/technology-20641465">2012-12-07 BBC News</a><br>
			<a href="http://tmp.virishi.net/OpenSkiesFeb2013-Bitcoin.pdf">2013-02-01 Open Skies</a><br>
			<a href="http://www.bbc.co.uk/news/technology-21964881">2013-04-28 BBC News</a>
		</p>
		<p><a href="mailto:vitalik@bitcoinmagazine.com">vitalik@bitcoinmagazine.com</a></p>
	</div>

	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/mike_caldwell.jpg" alt="Mike Caldwell">
	<p>Mike Caldwell</p>
	<p>Developer and Entrepreneur</p>
	<p class="details">
	<a href="http://www.bbc.com/future/story/20130412-bitcoin-and-the-illusion-of-money">2012-04-12 BBC News</a><br>
	<a href="http://www.businessweek.com/magazine/content/11_26/b4234041554873.htm">2011-06-16 BusinessWeek</a><br>
	<a href="http://www.wired.com/wiredenterprise/2013/03/bitcoin-ring/">2013-03-18 Wired</a>
	</p>
	<p><a href="mailto:mcaldwell@swipeclock.com">mcaldwell@swipeclock.com</a></p>
	</div>

	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/tony_gallippi.jpg" alt="Tony Gallippi">
	<p>Tony Gallippi</p>
	<p>CEO Bitpay</p>
	<p class="details">
	...
	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/jeff_garzik.jpg" alt="Jeff Garzik">
	<p>Jeff Garzik</p>
	<p>Developer</p>
	<p class="details">
	...
	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/mike_hearn.jpg" alt="Mike Hearn">
	<p>Mike Hearn</p>
	<p>Developer</p>
	<p class="details">
	...
	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/trace_mayer.jpg" alt="Trace Mayer">
	<p>Trace Mayer, J.D.</p>
	...
	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/felix_moreno_de_la_cova.jpg" alt="Felix Moreno de la Cova">
	<p>Felix Moreno de la Cova</p>
	<p>Trader and Portfolio Manager</p>
	<p class="details">
	<a href="http://www.lasexta.com/noticias/economia/bitcoin-estafa-moneda-futuro_2013040900240.html">2013-04-09 LaSexta (Es)</a><br>
	<a href="http://actualidad.rt.com/economia/view/90076-bitcoin-fracaso-euro">2013-03-27 Russia Times (Es)</a><br>
	...
	<div class="subnail_txt">
	<img src="http://bitcoin.org/img/press/volunteer/joerg_platzer.jpg" alt="Joerg Platzer">
	<p>Joerg Platzer</p>
	<p>Crypto economist</p>
	<p class="details">
	<a href="http://www.theguardian.com/technology/2013/apr/26/bitcoins-gain-currency-in-berlin">2013-04-26 The Guardian</a><br>
...
<p>Communicate with the <a href="https://bitcoinfoundation.org/contact">Bitcoin Foundation</a> board members.</p>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">What is Bitcoin?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">How does Bitcoin work?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">What is Bitcoin mining?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">How does one acquire bitcoins?</a>
  <div>
  <ul>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin really used by people?</a>
  <div>
  ...
  <p>
  <img style="height:165px;width:380px;" src="http://bitcoin.org/img/faq/merchants_map.png" alt="Screenshot">
  </p>
  </div>
</div>
<div>
  <a href="javaScript:" onclick="faqShow(event);">How difficult is it to make a Bitcoin payment?</a>
  <div>
  ...
  <p><img src="http://bitcoin.org/img/faq/mobile_send.png" style="height:325px;width:190px;" alt="Screenshot"><img src="http://bitcoin.org/img/faq/mobile_receive.png" style="height:325px;width:190px;" alt="Screenshot"></p>
  </div>
</div>
<div>
  <a href="javaScript:" onclick="faqShow(event);">What are the advantages of Bitcoin?</a>
  <div>
  <ul>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">What are the disadvantages of Bitcoin?</a>
  <div>
  <ul>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin secure?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin legal?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">What about Bitcoin and taxes?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin useful for illegal activities?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin a bubble?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Why do bitcoins have value?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin a Ponzi scheme?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Who created Bitcoin?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Can bitcoins become worthless?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin fully virtual and immaterial?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Why do people trust Bitcoin?</a>
  <div>
...
<div>
  <a href="javaScript:" onclick="faqShow(event);">Is Bitcoin anonymous?</a>
  <div>
...
<p>To learn more about Bitcoin, please visit the complete <a href="/en/faq">FAQ</a> or the <a href="https://en.bitcoin.it/wiki/FAQ">Bitcoin Wiki</a>.</p>
...
<div>
<a href="https://www.youtube.com/watch?v=LP4GSvQUtBw&amp;feature=player_embedded" target="_blank"><img src="http://bitcoin.org/img/press/video/funke.jpg" alt="what is Bitcoin"></a><br>
...
<div>
<a href="https://www.youtube.com/watch?v=Um63OQz3bjo&amp;feature=player_embedded" target="_blank"><img src="http://bitcoin.org/img/press/video/whatisbitcoin.jpg" alt="what is Bitcoin"></a><br>
...
<div>
	<a href="https://docs.google.com/uc?export=view&amp;id=0B4t9VJLm_PWhckxzRm5vS2ZtOWM" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_kiez.jpg" alt="Bitcoin Kiez sign">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0BwnE6HIoU4a4bUswMm5UWS1XakU" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_plain.png" alt="Bitcoin logo">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0BwnE6HIoU4a4Z2FaVTZ0NmRjSmc" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_qt.png" alt="Bitcoin Qt logo">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bxtcokiuvb4fZjlvNjhTN2Q4aUE" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_3d.png" alt="3D Bitcoin artwork by Eivind Nag" title="3D Bitcoin artwork by Eivind Nag">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0BwnE6HIoU4a4MG9oY1hTSTRBMHM" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_euro.png" alt="Bitcoin euro">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0BwnE6HIoU4a4RUZwY1Bzd3ZMa1E" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_gold.png" alt="Bitcoin gold">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bxtcokiuvb4fa3QweHlqTTE2U3c" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_3d_light.png" alt="Bitcoin 3D" title="3D Bitcoin artwork by Eivind Nag">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bxtcokiuvb4fVTVhcDQzRVNBelk" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_3d_perspective.png" alt="Bitcoin 3D" title="3D Bitcoin artwork by Eivind Nag">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bxtcokiuvb4fcVQzWkNHYm5jbE0" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_logo_3d_wood.png" alt="Bitcoin 3D" title="3D Bitcoin artwork by Eivind Nag">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0BwnE6HIoU4a4NjlNLVM2dzJXLUk" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_casascius_holograph.png" alt="Bitcoin Casascius holograph coin">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bw3qRtSO3WwtMHByaTB1NmNSdTg" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_cybrbeast4.png" alt="Bitcoin Cybrbeast 3D artwork">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bw3qRtSO3WwtbFhyb0YybHdhWEU" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_cybrbeast1.png" alt="Bitcoin Cybrbeast 3D artwork">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bw3qRtSO3WwtV1BCLUQ1cHhOaDA" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_cybrbeast2.png" alt="Bitcoin Cybrbeast 3D artwork">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bw3qRtSO3WwtT2ZLUzZyYUlJaGs" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_cybrbeast3.png" alt="Bitcoin Cybrbeast 3D artwork">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bw3qRtSO3WwtVnV1X1ktLW83Uzg" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_wood.png" alt="Bitcoin wood artwork">
	</a>
	<a href="https://docs.google.com/uc?export=view&amp;id=0Bw3qRtSO3WwtRkxSRDZtQXFTbWc" target="_blank">
		<img src="http://bitcoin.org/img/press/picture/bitcoin_casascius_metal.png" alt="Bitcoin Casascius metal coin">
	</a>
</div>
...
<p><span>Bitcoin is a technological tour de force.</span><span>Bill Gates, Executive Chairman, Microsoft<br>Eric Schmidt, Executive Chairman, Google</span></p>
<p><span>You can basically put a bank in your pocket... That's pretty amazing.</span><span>Gavin Andresen, Chief Scientist, The Bitcoin Foundation</span></p>
<p><span>Bitcoin allows wealth to be reduced to pure information and transmitted costlessly around the world—something nobody knew how to do before 2009. Its applications won’t be immediately obvious, especially to ordinary users.</span><span>Timothy B. Lee, Reporter, The Washington Post</span></p>
...
<p><span>Had you asked me five years ago, I would just say it was impossible. Bitcoin and crypto currencies solved this problem of coming to a consensus globally where you don't trust anybody else.</span><span>Richard Brown, Executive architect, IBM</span></p>
<p><span>We believe that Bitcoin represents something fundamental and powerful ... It reminds us of SMTP, HTTP, RSS, and BitTorrent in its architecture and openness.</span><span>Fred Wilson, Co-Founder of Union Square Ventures</span></p>
<p><span>It represents a remarkable conceptual and technical achievement, which may well be used by existing financial institutions (which could issue their own bitcoins) or even by governments themselves.</span><span>François R. Velde, Economist, Federal Reserve</span></p>
<p><span>All the things that gold does, Bitcoin kind of does better.</span><span>Naval Ravikant, Founder of Angellist</span></p>
...
<div>
  <a href="http://www.finextra.com/Video/Video.aspx?videoid=513"><img src="http://bitcoin.org/img/press/news/news_finextra.jpg" alt="Preview"></a>
...
<div>
  <a href="https://www.youtube.com/watch?v=drPkfGUZBqY&amp;feature=player_embedded"><img src="http://bitcoin.org/img/press/news/news_channel8.jpg" alt="Preview"></a>
...
<div>
  <a href="http://www.youtube.com/watch?v=FnNnZLkHnG4"><img src="http://bitcoin.org/img/press/news/news_ft.jpg" alt="Preview"></a>
...
<div>
  <a href="http://www.youtube.com/watch?v=_U18FG3ZAno"><img src="http://bitcoin.org/img/press/news/news_forbes.jpg" alt="Preview"></a>
...
<div>
  <a href="http://www.theguardian.com/technology/2013/apr/26/bitcoins-gain-currency-in-berlin"><img src="http://bitcoin.org/img/press/news/news_guardian.jpg" alt="Preview"></a>
...
<div>
  <a href="http://www.youtube.com/watch?v=6SLPy89gPE0"><img src="http://bitcoin.org/img/press/news/news_bloomberg.jpg" alt="Preview"></a>
...
<div>
  <a href="http://video.foxbusiness.com/v/2277786423001/"><img src="http://bitcoin.org/img/press/news/news_fox_trace.jpg" alt="Preview"></a>
